...
/**
 * @description
 * This spec file contains test to verify that admin can edit welcome message and create a user
 * @file
 * ui/cypress/e2e/server/services/SSH/admin-create-welcome-message-acceptance.cy.js
 * @breadcrumb
 * Login > Connections > Messages
 *
 * @assertions
 * To verify that admin is able to edit welcome message and create a user
 *
 */
slowCypressDown(100)

describe('login > edit welcomeMsg > create user ', () => {
  ...
  it('edit welcome message and create a user', () => {
