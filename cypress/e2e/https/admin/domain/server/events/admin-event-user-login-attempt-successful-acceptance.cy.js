...
/**
 * @description
 * This spec file contains test to verify that admin can create an event when a login attempt is successful
 *
 *
 * @breadcrumb
 ...
 *
 * @assertions
 * To verify that admin can create an event when a login attempt is successful
 *
 *  @prerequisites
 * Pre-Requisite data:
